...
#define SERVICE_UUID        "08ec67eb-037a-42fb-8109-055f65968b61"
#define CHARACTERISTIC_UUID "9ad75a91-a408-413c-9f96-ac676716cafd"
...
void loop() {
    ...
    if (deviceConnected) {
        pCharacteristic->setValue((uint8_t*)&value, 30);
